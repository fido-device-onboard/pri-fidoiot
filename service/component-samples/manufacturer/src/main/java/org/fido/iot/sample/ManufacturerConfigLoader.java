...
public class ManufacturerConfigLoader {
  ...
  private static Logger logger = LoggerFactory.getLogger(ManufacturerConfigLoader.class);
  ...
  static {
    ...
    try {
      ...
      logger.error("The Manufacturer application might not be using config file");
