...
INSERT INTO SYSTEM_MODULE_RESOURCE (CONTENT,CONTENT_TYPE_TAG,PRIORITY ) VALUES('F5','fdo_sys:active',0  );
...
UPDATE MT_SETTINGS SET RENDEZVOUS_INFO = 'http://localhost:8080?ipaddress=127.0.0.1&ownerport=8443' WHERE ID=1;
