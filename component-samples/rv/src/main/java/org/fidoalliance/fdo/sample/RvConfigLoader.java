...
public class RvConfigLoader {
  ...
  static {
    ...
    logger = new LoggerService(RvConfigLoader.class);
    try {
      ...
      logger.warn("The RV application might not be using config file");
  ...
  public static String loadConfig(String property) {
    try {
      ...
      logger.error("Exception raised while loading property:" + property);
      return null;
    }
  }
}
