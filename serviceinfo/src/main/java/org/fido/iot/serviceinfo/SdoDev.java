...
public final class SdoDev {
  ...
  public static final String KEY_BIN = NAME + ":bin";
  public static final String KEY_VERSION = NAME + ":version";
  public static final String KEY_DEVICE = NAME + ":device";
  public static final String KEY_SN = NAME + ":sn";
  public static final String KEY_PATHSEP = NAME + ":pathsep";
  public static final String KEY_SEP = NAME + ":sep";
