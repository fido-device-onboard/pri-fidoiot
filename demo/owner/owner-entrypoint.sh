...
keytool -importkeystore -deststorepass $owner_keystore_password -destkeystore NONE -srckeystore owner_keystore.p12 -deststoretype PKCS11 -srcstoretype PKCS12 -srcstorepass $owner_keystore_password
