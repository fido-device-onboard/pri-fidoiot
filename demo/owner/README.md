...
| POST /api/v1/owner/svi/mtu/?id=<serial_no> | Updates Maximum MTU that can be accepted by owner for serviceinfo transfer in `TO2_SETTINGS` table.| Query - id: Serial ID | application/text| New MTU value| |
