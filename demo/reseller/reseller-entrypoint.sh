...
keytool -importkeystore -deststorepass $reseller_keystore_password -destkeystore NONE -srckeystore reseller_keystore.p12 -deststoretype PKCS11 -srcstoretype PKCS12 -srcstorepass $reseller_keystore_password -alias reseller_ecdsa_256
